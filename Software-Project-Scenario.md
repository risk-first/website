...
Let's say that we are working in a Startup, on a project building an online service.  As we discussed previously, we could call this a [Goal](Glossary.md#goal-in-mind), but we could also restate it as mitigating [Risk](Glossary.md#attendant-risk), which gives more clarity about our intentions.   For the startup, launching the Online Service is about mitigating ([Funding-Risk](Scarcity-Risk.md#funding-risk)), in order to keep the startup alive. 

## Attendant Risks

What are the [Attendant Risks](Glossary.md#attendant-risk) that come with that goal?  Here are some to get us started:
...
5. The functionality isn’t there that the user needs ([Feature Risk](Feature-Risk.md)).
6. Our [Internal Model](Glossary.md#Internal-Model) of the market is poor, and we could be building the wrong thing.
...
Next, we can look at each of these risks and consider the threat they represent.  The same [Attendant Risks](Glossary.md#attendant-risk) will be evaluated differently depending on the _nature of the project_ and the mitigations you already have in place.  For example:
...
* If our **[Internal Model](Glossary.md#Internal-Model) is wrong**, then is there a chance we are building something for a non-existent market?  Or annoying our customers?  Or leaving an opportunity for competitors?
...
- It's possible that for the developers in question, security concerns were a [Hidden Risk](Glossary.md#Hidden-Risk): they were not aware of the dangers of being hacked.
...
- But, as the number of users of the sites increased, the risk increased too, but there was (apparently) no re-evaluation of the risk otherwise they would have addressed it.  This was a costly _failure to update the [Internal Model](Glossary.md#Internal-Model)_.

![Attendant Risks of Improved Security](images/generated/introduction/software_project_scenario_action_2.png)

This story highlights a couple of important lessons.  <!-- tweet-start -->First, when exposing a service on the Internet, it's now a good idea to _look for trouble_:  you should go out and try and improve your [Internal Model](Glossary.md#Internal-Model).<!-- tweet-end -->   Thankfully, this is what sites like [OWASP](https://www.owasp.org/index.php/Top_10-2017_Top_10) are for:  they _tell you about the [Attendant Risks](Glossary.md#attendant-risk)_ <!-- tweet-end --> and further, try to provide some evaluation of them to guide your actions.   Second, you shouldn't expect an organisation with a morally-questionable business model to have your best interests at heart.
...
Which actions give us the biggest benefit in terms of mitigating [Attendant Risk](Glossary.md#attendant-risk)?
