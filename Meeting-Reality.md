...
In [A Simple Scenario](A-Simple-Scenario.md), we looked at a basic model for how **Reality** and our [Internal Model](Glossary.md#Internal-Model) interacted with each other:  we take action based on our [Internal Model](Glossary.md#Internal-Model), hoping to **change Reality** with some positive outcome.
