...
- Mitigate [Complexity Risk](Complexity-Risk) by employing _abstraction_, _componentization_ and _modularization_ to remove duplication and reduce cross-cutting concerns.   By becoming less complex, the code has less [Inertia](Complexity-Risk).
