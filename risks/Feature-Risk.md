...
I face market risk when I own (i.e. have a _position_ in) some [Apple](https://apple.com) stock. <!-- tweet-end --> [Apple's](http://apple.com) stock price will decline if a competitor brings out an amazing product, or if fashions change and people don't want their products any more.
