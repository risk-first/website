...
Having an event occur in a fixed time and place is [mitigating risk](Glossary.md#Mitigated-Risk):
...
By _deciding to use the bus_ we've [Taken Action](Glossary.md#Taking-Action).  By agreeing a _time_ and _place_ for something to happen (creating an _event_, as shown in the diagram above), you're introducing [Deadline Risk](Deadline-Risk.md).  Miss the deadline, and you miss the bus.
