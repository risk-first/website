...
practice:
  ...
  mitigates:
    - tag: Communication Risk
      reason: "Ensures that the project scope is clearly communicated to all parties."
...
| --------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| **Project Charter**   | High-level document authorising a project and defining its objectives.    | [Project Charter, Wikipedia](https://en.wikipedia.org/wiki/Project_charter)     |
| **Statement of Work** | Detailed description of work to be performed, deliverables, and timeline. | [Statement of Work, Wikipedia](https://en.wikipedia.org/wiki/Statement_of_work) |
| **Scope Document**    | Document defining what is and isn't included in the project.              | [Scope, Wikipedia](<https://en.wikipedia.org/wiki/Scope_(project_management)>)  |
