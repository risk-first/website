...
|[Agency Risk](/tags/Agency-Risk)                          |Risks that staff have their own [Goals](/thinking/Glossary#goal), which might not align with those of the project or team.|
...
|[Map And Territory Risk](/tags/Map-And-Territory-Risk)    |Risks due to the fact that people don't see the world as it really is. (After all, they're working off different, imperfect [Internal Models](/thinking/Glossary#internal-model).)|  
...
All the [Risks](/thinking/Glossary#risk) were [correlated](https://www.investopedia.com/terms/c/correlation.asp).  That is, they were affected by the _same underlying events_, or _each other_.
