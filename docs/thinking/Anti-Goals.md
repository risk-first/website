...
As we've seen before, the purpose of doing any work on a software project is to [manage risk](/thinking/Just-Risk.md). Each task on the project can be re-framed as a risk, and completing the task absolves you of the risk.
