...
![Stake and Reward for Fixing Technical Debt](/img/generated/bets/coding/refactoring.svg)
...
![Stake and Reward for A Spike Solution](/img/generated/bets/coding/spike.svg)
...
![New Market Bet](/img/generated/bets/coding/new-market.svg)
...
The best gamblers (the ones who win over time) don't necessarily take bets they'll always win.  But they are always judging risk, stake and reward.  They try to place bets where the [Balance of Risk](/tags/Balance-Of-Risk) is in their favour.   As developers, we should adopt the same mind-set:

 - What are the likely stakes?
 - What is the [Payoff](/tags/Payoff)?
 - What are the odds?
 - Is the bet worth it?  Do the stakes justify the [Payoff](/tags/Payoff)?
