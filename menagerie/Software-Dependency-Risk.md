...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------:|:-------------:|:-------------------:|:------------------:|--------------| 
| Is the project "famous"?                                                                                                                                                                                  |                   | &middot;      | &middot;            | &middot;           | [sd2], [sd3] | 
| Is there evidence of a large user community on user forums or e-mail list archives?                                                                                                                       |                   | &middot;      | &middot;            | &middot;           | [sd1]        | 
| Who is developing and maintaining the project? (Track Record)                                                                                                                                             |                   | &middot;      | &middot;            | &middot;           | [sd3]        | 
| What are the mechanisms for supporting the software (community support, direct email, dedicated support team), and how long will the support be available? The more support, the better                   |                   |               | &middot;            | &middot;           | [sd1]        | 
| Is the API to your liking?                                                                                                                                                                                |                   |               |                     | &middot;           | [sd2]        | 
| Are there examples of using the software successfully in the manner you want to use it?                                                                                                                   |                   |               | &middot;            |                    | [sd1]        | 
| Are all the features you need, and think you will need, included?                                                                                                                                         |                   |               | &middot;            |                    | [sd1]        | 
| How mature is the project?                                                                                                                                                                                |                   |               | &middot;            |                    | [sd2]        | 
| In respect to the software licence, do you have the right to use the software in its intended production environment, or the right to distribute it along with your software?                             |                   |               | &middot;            |                    | [sd1]        | 
| What is its deprecation or versioning policy? Does it have one? If not then it may be more unstable and features may disappear without warning between versioning, especially if releases are frequent.   |                   | &middot;      | Regression Risk     | &middot;           | [sd1]        | 
| What does the codebase look like?                                                                                                                                                                         |                   |               | Implementation Risk |                    | [sd3]        | 
| How frequent are its releases?                                                                                                                                                                            |                   |               | &middot;            |                    | [sd1], [sd2], [sd3]| 
| How well documented is the project?                                                                                                                                                                       |                   |               |                     | &middot;           | [sd2]        | 
| Does the software have evidence of a sustainable future (e.g. is there a roadmap)?                                                                                                                        |                   | &middot;      |                     |                    | [sd1]        | 
| Does the software support open standards? If it does, it will be easier to replace the software should it come to the end of its lifetime                                                                 |                   | &middot;      |                     |                    | [sd1]        | 
| Does the version you intend to use come from a forked open-source project, or is it from the original source project? If so, which source is more appropriate?                                            |                   | &middot;      |                     |                    | [sd1]        | 
| Are there any alternatives to the software?                                                                                                                                                               |                   | &middot;      |                     |                    | [sd1]        | 
| Has your community converged on using a particular software package?                                                                                                                                      | &middot;          |               |                     |                    | [sd1]        | 
| **Totals**                                                                                                                                                                                                | **1**             | **9**         | **15**              | **8**              |              | 
