...
| Concern                                                                                                                               | ![Coordination Risk](images/generated/coordination-risk.png) |![Boundary Risk](images/generated/boundary-risk.png) | ![Feature Fit Risk](images/generated/feature-risk.png)    | ![Communication Risk](images/generated/communication-risk.png) | Source       | 
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------:|:-------------:|:-------------------:|:------------------:|--------------| 
