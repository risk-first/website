  ...
  return (
    <div className={styles.episode}>
      ...
      <div className={styles.content}>
        ...
        <div className={`${styles.description} ${expanded ? styles.expanded : styles.collapsed}`} dangerouslySetInnerHTML={{ __html: description }} />
        <div className={styles.links}>
          <button className={`${styles.link} ${styles.toggleButton}`} onClick={toggle}>
            {expanded ? 'Show less' : 'Read more'}
          </button>
          {spotify && (
            <a href={spotify} target="_blank" rel="noopener noreferrer" className={`${styles.link} ${styles.spotifyLink}`}>
          ...
          {youtube && (
            <a href={youtube} target="_blank" rel="noopener noreferrer" className={`${styles.link} ${styles.youtubeLink}`}>
              <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
